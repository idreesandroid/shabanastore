                        ...
                        <div id="similar-product" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    @foreach($slid1 as $item)
                                        <a href=""><img src="{{asset('assets/images/product-details/similar'.$item.'.jpg')}}" alt=""></a>
                                    @endforeach
                                </div>
                                <div class="item">
                                    @foreach($slid2 as $item)
                                        <a href=""><img src="{{asset('assets/images/product-details/similar'.$item.'.jpg')}}" alt=""></a>
                                    @endforeach
                                </div>
                                <div class="item">
                                    @foreach($slid3 as $item)
                                        <a href=""><img src="{{asset('assets/images/product-details/similar'.$item.'.jpg')}}" alt=""></a>
                                    @endforeach
                                </div>
                    ...
                    <div class="col-sm-7">
                        <div class="product-information"><!--/product-information-->
                            ...
                            <span>
									...
									<a href="{{url('cart')}}" class="btn btn-fefault cart">
